...
public class GoIbibo {
	...
	public  void main2() throws InterruptedException {
		...
		WebElement flightCount = driver.findElement(By.xpath("//span[@class='greyCnt']")); 	//flightCount(showing 37 flights)
		String strFlightCount = flightCount.getText().replaceAll("[^0-9]", ""); 	//removing letters(from showing 37 flights)
		int intFlightCount = Integer.parseInt(strFlightCount);		//converting str to int(37)
		...
		for(;;) {
			...
			if(intFlightCount == allPrices.size()) {
